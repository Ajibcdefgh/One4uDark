...
async def draw_meme_text(image_path, text):
    ...
    m_font = ImageFont.truetype("fontx/FontRemix.ttf", int((70 / 640) * i_width))
    if ";" in text:
...
CMD_HELP.update(
    {
        "glitch": ">`.glitch <1-8>`"
        "\nUsage: Balas stiker/gambar dan kirim dengan .glitch.\nvaluenya berkisar 1-8 jika tidak akan memberikan nilai default yaitu 2"
    }
)
