...
async def kang(args):
    ...
    if message and message.media:
        ...
        await args.edit("`Reply yang bener...`")
        return
    ...
    if photo:
        ...
        await args.edit(
            f"`Stiker Sukses Tercolong!`\
            \nPack gua bisa lu pake di [sini](t.me/addstickers/{packname})",
            parse_mode="md",
        )
...
async def get_pack_info(event):
    ...
    try:
        ...
        await event.edit("`Ini bukan stiker. Balas stiker.`")
        return
